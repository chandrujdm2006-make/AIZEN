...
export default function DynamicControlPanel({ onPlanUpdated }) {
  ...
  return (
    <div className="space-y-5 animate-fade-in pb-12">
      ...
      <div className="bg-[#090D17]/95 border border-[#1E2638] p-4 rounded-2xl shadow-xl flex flex-wrap items-center justify-between gap-4 backdrop-blur-xl">
        <div>
          <div className="flex items-center gap-2.5">
            <div className="p-2 bg-violet-600/20 border border-violet-500/40 rounded-xl text-violet-400 shadow-inner">
            ...
            <div>
              <div className="flex items-center gap-2">
                ...
                <span className="bg-cyan-950/80 text-cyan-300 border border-cyan-500/50 text-[10px] font-mono font-bold px-2 py-0.5 rounded shadow-sm shadow-cyan-900/30">
                  LIVE ARBITRATION
                </span>
              </div>
        ...
        <div className="flex items-center flex-wrap gap-2.5">
          {/* Commander Input */}
          <div className="flex items-center gap-1.5 bg-[#0D1322] border border-[#212C44] px-2.5 py-1.5 rounded-xl text-xs">
          ...
          <button
            ...
            className={`px-3 py-1.5 rounded-xl border text-xs font-mono flex items-center gap-1.5 transition-all cursor-pointer ${
              autoReplan
                ? 'bg-violet-600/30 border-violet-500 text-violet-300 shadow-sm shadow-violet-500/30'
                : 'bg-[#0D1322] border-[#212C44] text-slate-400 hover:text-white'
            }`}
          ...
          <button
            ...
            disabled={syncing}
            className="px-3 py-1.5 rounded-xl border border-[#232F48] bg-[#111726] hover:bg-[#182136] text-slate-200 text-xs font-semibold flex items-center gap-1.5 transition-all cursor-pointer disabled:opacity-50"
          ...
          {/* Sync & Re-plan Button (Electric Violet) */}
          <button
            onClick={handleSync}
            ...
            className={`px-4 py-1.5 rounded-xl text-xs font-bold font-mono tracking-wide flex items-center gap-2 shadow-lg transition-all cursor-pointer ${
              hasHardError && allocationMode === 'manual'
                ...
                : 'bg-gradient-to-r from-violet-600 via-purple-600 to-indigo-600 hover:from-violet-500 hover:to-indigo-500 text-white shadow-violet-900/40 border border-violet-400/30 hover:-translate-y-0.5'
            }`}
          >
      ...
      <div className="bg-[#0D1322]/85 border border-[#212C44] rounded-2xl p-4 shadow-xl space-y-4 backdrop-blur-xl">
        <div className="flex flex-wrap items-center justify-between gap-3 border-b border-[#1E2638] pb-3">
          ...
          <div className="flex items-center gap-1.5 bg-[#080D16] p-1 rounded-xl border border-[#1E2638] text-xs">
            {zones.map(z => {
              ...
              return (
                <button
                  ...
                  className={`px-3 py-1.5 rounded-lg flex items-center gap-1.5 transition-all cursor-pointer font-mono ${
                    isActive
                      ? 'bg-gradient-to-r from-violet-600 to-purple-600 text-white shadow-md shadow-violet-900/50 font-bold'
                ...
                >
                  ...
                  <span className={`text-[10px] px-1.5 py-0.2 rounded font-bold ${
                    isActive
                      ? 'bg-violet-950 text-cyan-200 border border-violet-700/50'
                ...
                <div>
                  <div className="flex items-center gap-2">
                    <input
                      ...
                      className="bg-transparent text-sm font-bold text-white focus:outline-none border-b border-transparent focus:border-violet-500 px-1"
                    />
                    <span className="text-[10px] font-mono bg-[#131A2B] text-slate-300 border border-[#212C44] px-2 py-0.5 rounded">
          ...
          <div className="flex items-center gap-1.5 bg-slate-950/90 p-1 rounded-xl border border-slate-800 text-xs font-mono">
            <button
              ...
              className={`px-3 py-1 rounded-lg flex items-center gap-1.5 transition-all cursor-pointer ${
                allocationMode === 'auto'
                  ? 'bg-gradient-to-r from-violet-600 to-purple-600 text-white font-bold shadow-md shadow-violet-900/30'
